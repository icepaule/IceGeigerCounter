// IceGeiger rear badge v1.5.3 - ACE two-color version
...
module artwork_2d(){
 union(){
  ...
  // v1.5.3: project-correct label and reduced size for safe badge margins.
  translate([10,0])text("IceGeiger",size=6.0,halign="center",valign="center",font="Liberation Sans:style=Bold");
 }
}
