...
![IceGeiger V2 Gehäusevorschau](docs/v2/images/v2_enclosure_assembled.jpg)
...
![Datenfluss](docs/v2/images/v2_architecture.svg)
...
## V2-Dokumentation
1. [Überblick und Designentscheidungen](docs/v2/00-overview.md)
2. [BOM / Einkaufsliste](docs/v2/01-bom.md)
3. [Elektrik und Verdrahtung](docs/v2/02-electrical-wiring.md)
4. [Firmware installieren und konfigurieren](docs/v2/03-firmware.md)
5. [Offline-Logging und WLAN-Backfill](docs/v2/04-mobile-logging-sync.md)
6. [LoRaWAN + ChirpStack Schritt für Schritt](docs/v2/05-lorawan-chirpstack.md)
7. [Home Assistant, MQTT, InfluxDB und Karte](docs/v2/06-home-assistant.md)
8. [Gehäuse / OpenSCAD / STL](docs/v2/07-enclosure.md)
9. [Zusammenbau Schritt für Schritt](docs/v2/08-assembly.md)
10. [Inbetriebnahme und Testplan](docs/v2/09-commissioning-test.md)
11. [Kalibrierung und Datenqualität](docs/v2/10-calibration-data-quality.md)
12. [Stationärer Betrieb im Schuppen](docs/v2/11-shed-operation.md)
13. [Quellen und verifizierte Daten](docs/v2/12-sources.md)
14. [Validierungsstatus](docs/v2/13-validation-status.md)
...
Nach Lieferung zuerst [`hardware/v2/MEASURE_AFTER_DELIVERY.md`](hardware/v2/MEASURE_AFTER_DELIVERY.md) abarbeiten, Werte in der `.scad`-Datei eintragen, `./scripts/build-stl.sh` ausführen und zuerst den Fit-Jig prüfen.
...
- Keine realen Zugangsdaten in Git speichern. Siehe [SECURITY.md](SECURITY.md).
